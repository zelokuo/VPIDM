...
class Specs(Dataset):
    ...
    def __getitem__(self, i):
        x, _ = load(self.clean_files[i].strip())
        y, _ = load(self.noisy_files[i].strip())
...
class SpecsDataModule(pl.LightningDataModule):
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument("--format", type=str, choices=("default", "dns", "librispeech"), default="default", help="Read file paths according to file naming format.")
